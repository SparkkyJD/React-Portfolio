...
export default function Contact() {
    ...
    return (
        <div className="max-w-md mx-auto h-[75vh]">
            ...
            <form onSubmit={handleSubmit} action="/send-email" method="POST" className="space-y-4 mx-8">
                ...
                <button type="submit" href="contact" className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 
            focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Submit
                </button>
            </form>
        </div>
    );
